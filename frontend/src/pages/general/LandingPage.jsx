        ...
        <>
            <nav className="navbar navbar-expand-lg bg-white sticky-top">
                <div className="container">
                    <a className="navbar-brand" href="landingpage.php">
                        <img src={myImage} alt="notfound" style={{ maxHeight: '50px', maxWidth: '50px' }} />
                    </a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" href="#portfolio">At a Glance</a>
                            </li>
                            <li className="nav-item">
                        ...
                        <a href="LogIn.php" className="btn btn-brand ms-lg-3">Join Us</a>
                    </div>
                </div>
            </nav>
            {/* HOME */}
            <section id="hero" style={heroStyles} class="min-vh-100 d-flex align-items-center text-center">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
            ...
            <section id="team" class="section-padding">
                ...
                {/* Contact Us */}
                    ...
                    <section style={ContactStyles} class="section-padding bg-light" id="contact">
                        <div class="container">
                            <div class="row">
